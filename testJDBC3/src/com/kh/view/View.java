...
public class View {
	...
	public void mainMenu() {
		...
		do {
			...
			if(mem == null) {
				...
				switch(select) {
				case 1 : mem = null; System.out.println("로그아웃 되었습니다."); break;
	...
	public void displayLoginError() {
		mem = null;  // 잘못된 정보를 넣어도 게시판이 돌아가는걸 방지
	...
	public void selectOne(Board board) {
		...
		System.out.printf("작성자 : %-10s wkrtjddlf %-15s\n" + board.getWriter(), board.getCreateDate());
		System.out.println("-------------------------------------");
	...
	public char deleteBoard() {
		//실제로 지우는게 아니고 안보이게 숨겨놓는것
		//status(delete yn)을 통해 숨기지 않는것만 조회가능하게 해놓음
