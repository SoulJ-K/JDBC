...
/*	- memberId : String
	...
	+ 기본생성자
	+ Member(memberId : String, memberPwd : String, memberName : Stirng, gender : char,  email : String,
				phone : String, age : int, address : String, enrollDate : Date)
	+ Member(memberId : String, memberPwd : String, memberName : Stirng, gender : char,  email : String,
				phone : String, age : int, address : String)
	+getter/setter
	+toString():Stirng
	반환값 : 아이디, 비밀번호, 이름, 성별, 이메일, 전화번호, 주소, 나이, 등록일  */
	...
	public void setMemerId(String memberId) {
		this.memberId = memberId;
	}
	...
	@Override
		public String toString() {
			return memberId + ", " + memberPwd + ", " + memberName + ", " + gender + ", " + email + ", " + phone + ", " + age + ", " + 
					address + ", " + enrollDate;
		}
}
